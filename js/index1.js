...
function draw(){
    ...
    payArray.forEach(function (item){
        list += '<tr>' +
            ...
            '<td>'+ item.payOrder +'</td>' +
            '<td>' +
            '<span class="btn btn-secondary">'+ item.payTarget +'</span>' +
            '</td>'+
            '<td>'+ item.payDate +'</td>' +
            '<td>' +
            '<button type="button" class="btn btn-dark" data-toggle="modal" data-target="#editModal" onclick="edit('+ item.id +')">Edit</button>' +
            '<button type="button" class="btn btn-secondary" onclick="remove('+ item.id +')">Remove</button>' +
            '</td>' +
            '</tr>'
